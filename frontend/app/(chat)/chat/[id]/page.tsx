...
const ChatById = () => {
    ...
    return (
        <div className='w-full cus-h-screen card p-0 overflow-hidden'>
            <div className='w-full h-5rem shadow-1 flex justify-content-start align-items-center px-5'>
            ...
            <div className='w-full relative chat-box'></div>

            <form
                className='w-full h-10rem relative'
                onSubmit={e => e.preventDefault()}
            >
                <div className='w-full absolute bottom-0 left-0 mb-5 flex column-gap-4 align-items-end px-5'>
                    <InputTextarea
                        autoResize
                        className='col max-h-10rem bg-gray-100'
                        rows={1}
                    />
                    <Button
                        type='button'
