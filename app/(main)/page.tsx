...
const Dashboard = () => {
    return (
        <div className='card flex flex-column align-items-center'>
            ...
            <div className='w-full flex flex-column justify-content-center align-items-center gap-3 my-2'>
            ...
            <div className='w-full grid justify-content-around gap-5 lg:gap-0 border-top-2 border-bottom-2 py-5 lg:px-5'>
                {items.map(item => (
                    <Link
                        href={item.link}
            ...
            <div className='w-full grid justify-content-around gap-5 my-5 lg:px-5'>
                <div className='col-12 md:col-5 p-card p-5 cursor-pointer hover:surface-200 shadow-4'>
                    <h1 className='text-xl font-bold'>
                        Case No : <span>1</span>
                    </h1>
                    <p className='text-lg'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Id diam maecenas ultricies mi eget mauris.</p>
